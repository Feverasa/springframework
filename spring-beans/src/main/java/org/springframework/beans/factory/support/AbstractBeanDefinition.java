...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	 ...
	 * constructor argument values and property values.     Argument  论据、争吵、主题  mutable 易变的
	 */
	...
	/**
	 * Validate(证实、合法性) and prepare the method overrides defined(明确的、有定义的) for this bean.
	 * Checks for existence of a method with the specified(指定) name.
	 * @throws BeanDefinitionValidationException in case of validation failure
	 */
