...
//            https://blog.csdn.net/wconvey/article/details/51119493
public class DefaultSingletonBeanRegistry extends SimpleAliasRegistry implements SingletonBeanRegistry {
	...
	/**
	 * Add the given singleton factory for building the specified(指定的) singleton
	 * if necessary.
	 ...
	 * @param beanName the name of the bean
	 * @param bean the bean instance  Disposable   一次性的  ，可任意处理的
	 */
	 ...
	 * @param beanName the name of the bean
	 * @return the array of dependent bean names, or an empty array if none   Dependent   依赖的
	 */
