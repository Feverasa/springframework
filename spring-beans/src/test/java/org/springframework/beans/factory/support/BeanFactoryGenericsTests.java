...
//		rbd.setAttribute("integerSet",input);
...
//		RootBeanDefinition perDefinition = new RootBeanDefinition(Person.class);
//		RootBeanDefinition schDefinition = new RootBeanDefinition(School.class);
//		bf.registerBeanDefinition("perDefinition", perDefinition);
//		bf.registerBeanDefinition("schDefinition", schDefinition);
//		Person person = (Person) bf.getBean("perDefinition");
