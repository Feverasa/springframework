...
public class StaticMessageSourceTests extends AbstractApplicationContextTests {
	...
	//At {1,time} on "", there was "" on planet .
	...
	public void getMessageWithDefaultPassedInAndFoundInMsgCatalog() {
		...
		System.out.println(sac.getMessage("message.format.example2", null, "This is a default msg if not found in MessageSource.", Locale.US));
	...
	public void getMessageWithMessageAlreadyLookedFor() {
		...
		System.out.println(sac.getMessage("message.format.example1", arguments, Locale.US));
